...
export default function AddSeasonPage() {
  ...
  const generateSlug = () => { if (titleEn || title) setSlug((titleEn || title).toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')); };
  ...
  const selectStyles: StylesConfig<SelectOption, true> = {
    ...
    noOptionsMessage: (base) => ({ ...base, color: document.documentElement.classList.contains('dark') ? '#9CA3AF' : '#6B7280' }),
  };
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Add New Season</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input type="text" value={thumbnailUrl} onChange={(e) => setThumbnailUrl(e.target.value)} placeholder="Or URL" className="flex-1 p-2 border rounded-md dark:bg-gray-700" />
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input type="text" value={thumbnailUrlEn} onChange={(e) => setThumbnailUrlEn(e.target.value)} placeholder="Or URL" className="flex-1 p-2 border rounded-md dark:bg-gray-700" />
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          <div className="mb-6">
            ...
            <Select isMulti value={episodeOptions.filter(o => selectedEpisodes.includes(o.value))} onChange={handleEpisodesChange} options={episodeOptions} styles={selectStyles} isClearable placeholder={isLoading ? 'Loading...' : 'Select'} />
          </div>
          <div className="mb-6">
            <label className="block text-sm font-medium mb-2">Articles</label>
            <Select isMulti value={articleOptions.filter(o => selectedArticles.includes(o.value))} onChange={handleArticlesChange} options={articleOptions} styles={selectStyles} isClearable placeholder={isLoading ? 'Loading...' : 'Select'} />
          </div>
        </div>
