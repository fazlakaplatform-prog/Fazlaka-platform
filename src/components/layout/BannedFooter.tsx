...
// واجهة للروابط الاجتماعية - تم استخدام id بدلاً من _id
...
export default function BannedFooter() {
    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex flex-col items-center text-center">
              <h3 className="text-xl font-bold text-white mb-3">{t.newsletter}</h3>
              <p className="text-gray-400 text-sm mb-6">{t.newsletterDesc}</p>
              <div className="w-full max-w-md">
                <NewsletterSubscribe variant="footer" language={isRTL ? 'ar' : 'en'} />
              </div>
            </div>
          </motion.div>
